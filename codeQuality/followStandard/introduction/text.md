...
**One essential way to improve code quality is to follow a consistent style. That is why software engineers usually follow a strict {{ show_term("coding standard") }} (aka _style guide_).**
