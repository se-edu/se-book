...
* Process requirements: e.g. the project is expected to adhere to a schedule that delivers a feature set every month.
...
1. sometimes **NFRs are critical to the success of the software.** %%E.g., a web application that is too slow or that has weak security is unlikely to succeed even if it has all the right functionality.%%
