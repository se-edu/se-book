...
<pic src="{{ baseUrl }}/architecture/introduction/what/images/architecture.png" /><pic eager class="tbg" src="{{baseUrl}}/architecture/architecturalStyles/layered/what/images/layeredExamples.svg" width="233" />
