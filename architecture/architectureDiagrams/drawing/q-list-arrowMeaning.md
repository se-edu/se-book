...
1. It cannot distinguish a one-way dependency from a two-way one, so the direction of each dependency — the most important information in the diagram — is lost.
