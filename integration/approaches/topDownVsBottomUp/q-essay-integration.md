...
<pic eager class="tbg" src="{{baseUrl}}/integration/approaches/topDownVsBottomUp/images/hospital.png" height="250" />
<p/>
...
* Because `HospitalFacade` is unlikely to have a lot of business logic, it may not be worth writing stubs to test it (i.e., a bottom-up integration is better for `HospitalFacade`).
...
<pic eager class="tbg" src="{{baseUrl}}/integration/approaches/topDownVsBottomUp/images/hospitalIntegration.png" height="250" />
<p/>
