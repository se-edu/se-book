...
**{{ show_term("Egoless team") }}**

In this structure, **every team member is equal in terms of responsibility and accountability**. When any decision is required, consensus must be reached. This team structure is also known as a _democratic_ team structure. It usually finds a good solution to a relatively hard problem as all team members contribute ideas.
...
**{{ show_term("Chief programmer team") }}**
...
**{{ show_term("Strict hierarchy team") }}**
