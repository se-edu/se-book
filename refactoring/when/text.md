...
An example (from the same source as above) is the code smell _data class_, i.e., a class with all data and no behavior. When you encounter such a class, you can explore whether moving the corresponding behavior into that class is appropriate. Some more examples:
