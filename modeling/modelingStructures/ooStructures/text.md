...
<panel src="../../../../book/uml/objectDiagrams/introduction/full.md" boilerplate header=":mortar_board: UML → Object Diagrams → Introduction" expanded/> 
<panel src="../../../../book/uml/classDiagrams/introduction/what/full.md" boilerplate header=":mortar_board: UML → Class Diagrams → Introduction → What" expanded/>
