...
<dynamic-panel src="../../../uml/classDiagrams/classInheritance/what/full.md#title-and-body" boilerplate header=":mortar_board: UML → Class Diagrams → Inheritance" expanded/>
