...
<panel src="../../../uml/classDiagrams/classes/what/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Class Diagrams → Classes" expanded />
<panel src="../../../uml/objectDiagrams/objects/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Object Diagrams → Objects" expanded/>
