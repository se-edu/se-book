...
<panel src="../../../uml/classDiagrams/classLevelMembers/what/embed-inOtherContext.md#title-and-body" boilerplate header="{{glyphicon_education}} Tools → UML → Class Diagrams → Class Level Members" expanded /><p/>
