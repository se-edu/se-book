...
<panel src="../../../uml/classDiagrams/associations/multiplicity/full.md#title-and-body" boilerplate header=":mortar_board: UML → Class Diagrams → Associations → Multiplicity" expanded />
