...
<panel src="../../../uml/classDiagrams/composition/what/embed-inOtherContext.md#title-and-body" boilerplate header="{{glyphicon_education}} Tools → UML → Class Diagrams → Composition" expanded/>
