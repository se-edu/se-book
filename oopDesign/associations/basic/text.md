...
<panel src="../../../uml/objectDiagrams/associations/what/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Object Diagrams → Associations → What" expanded />
...
<panel src="../../../uml/classDiagrams/associations/basic/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Class Diagrams → Associations → Basic" expanded/>
...
<panel src="../../../uml/classDiagrams/associations/roles/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Class Diagrams → Associations → Roles" expanded />
<panel src="../../../uml/classDiagrams/associations/labels/full.md#title-and-body" boilerplate header=":mortar_board: Tools → UML → Class Diagrams → Associations → Labels" expanded />
