...
* **Control coupling**: one module controls the flow of another by passing it information on what to do %%e.g., passing a flag%%
* **Data coupling**: one module shares data with another module %%e.g., via passing parameters%%
