...
* The constructor does not return anything. A constructor returns the created object by default.
...
**You can add methods to a class; these methods can then be called on objects of that class.** These _instance_ methods do not have the `static` keyword in their method signature. Instance methods can access attributes of the class.
