...
**Coverage analysis can be useful in improving the quality of testing.** For example, if a set of test cases does not achieve 100% branch coverage, more test cases can be added to cover missed branches.
