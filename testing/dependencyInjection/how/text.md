...
**Polymorphism can be used to implement dependency injection**, as can be seen in the example given in <trigger trigger="click" for="modal:useDi-stub">[Quality Assurance &rarr; Testing &rarr; Unit Testing &rarr; Stubs]</trigger> where a stub is injected to replace a dependency.
