...
<pic eager class="tbg" src="{{baseUrl}}/testCaseDesign/summary/exercises/images/manWoman.png" height="90" />
<p/>

<panel type="seamless" header="{{ icon_A }} Answer" minimized>

<pic eager class="tbg" src="{{baseUrl}}/testCaseDesign/summary/exercises/images/manWomanPartitions.png" height="300" />
<p/>
