...
* ++**What**++ : the **meaning** of the concept concerned (<trigger trigger="click" for="modal:conventions-what">example</trigger>)
...
* ++**Why**++ : the **motivation** behind the concept concerned (<trigger trigger="click" for="modal:conventions-why">example</trigger>)
...
* ++**How**++ : the **usage** of the concept concerned (<trigger trigger="click" for="modal:conventions-how">example</trigger>)
...
* ++**When**++ : the **pros and cons** of the concept concerned, **when to use** the concept (<trigger trigger="click" for="modal:conventions-when">example</trigger>)
