<panel header="{{ icon_Q_A }} Use case diagram for a ticket vending machine">
...
<pic eager class="tbg" src="{{baseUrl}}/specifyingRequirements/useCases/identifying/images/ticketMachine.png" width="300" />
